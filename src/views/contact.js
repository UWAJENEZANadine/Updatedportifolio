...
import { LinkedinOutlined, TwitterOutlined, WhatsAppOutlined } from "@ant-design/icons";
      ...
      <div className="container">
        <div className="row jutstify-content-around row1">
          <div className="col-9 col-sm-7 col-md-7 mt-5">
            ...
            <a href="https://www.linkedin.com/in/uwajeneza-nadine-9686091b6/" target="blank" style={{fontSize:"2em", color:"white"}} > <LinkedinOutlined className="px-5"/></a>
           <a href="https://twitter.com/UWAJENEZANADIN4" target="blank" style={{fontSize:"2em", color:"white"}}><TwitterOutlined /></a>
          </div>
